from tkinter import *
from lostark_archaeology_guide_MVC.view.frame.lower_frame import LowerFrame
from lostark_archaeology_guide_MVC.view.frame.upper_frame import UpperFrame
